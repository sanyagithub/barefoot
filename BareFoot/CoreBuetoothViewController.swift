//
//  CoreBuetoothViewController.swift
//  BareFoot
//
//  Created by Sanya Khurana on 18/09/19.
...
let BLE_Lesson_Plan_Characterstic_CBUUID = CBUUID(string: "0x180D")

// MARK: - Core Bluetooth characteristic IDs
let BLE_Activities_Characteristic_CBUUID = CBUUID(string: "0x2A37")
let BLE_Attendance_Table_Characteristic_CBUUID = CBUUID(string: "0x2A38")
...
class CoreBluetoothViewController: UIViewController, CBCentralManagerDelegate, CBPeripheralDelegate {
    ...
    func centralManagerDidUpdateState(_ central: CBCentralManager) {
        ...
        case .poweredOn:
            ...
            centralManager?.scanForPeripherals(withServices: [BLE_Lesson_Plan_Characterstic_CBUUID])
    ...
    func centralManager(_ central: CBCentralManager, didConnect peripheral: CBPeripheral) {
        ...
        peripheralMonitor?.discoverServices([BLE_Lesson_Plan_Characterstic_CBUUID])
    ...
    func peripheral(_ peripheral: CBPeripheral, didDiscoverServices error: Error?) {
        ...
        for service in peripheral.services! {
            ...
            if service.uuid == BLE_Lesson_Plan_Characterstic_CBUUID {
    ...
    func peripheral(_ peripheral: CBPeripheral, didDiscoverCharacteristicsFor service: CBService, error: Error?) {
        ...
        for characteristic in service.characteristics! {
            ...
            if characteristic.uuid == BLE_Activities_Characteristic_CBUUID {
            ...
            if characteristic.uuid == BLE_Lesson_Plan_Characterstic_CBUUID {
